...
import com.agvber.kekkek.core.firestore.WITHDRAW_USER_COLLECTION
import com.agvber.kekkek.core.firestore.dao.UserDao
import com.agvber.kekkek.core.firestore.model.ActivitiesEntity
...
internal class UserDaoImpl @Inject constructor(
    ...
    override suspend fun setUserName(uid: String, name: String) {
        firestore
    ...
    override suspend fun setUserIntroduction(uid: String, introduction: String) {
        firestore
            .collection(USER_COLLECTION)
            .document(uid)
            .update(mapOf("introduction" to introduction))
            .await()
    }
